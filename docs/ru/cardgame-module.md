...
находится в [`Ruleshift/example`](https://github.com/Ruleshift/example/tree/main/modules/cardgame)
и реализует Module Runtime ABI v1.
...
```powershell
docker build -f modules/cardgame/Dockerfile `
...
- `modules/cardgame/manifest.json`;
- сгенерированным `descriptor.pb`;
- `modules/cardgame/conformance.json`.
