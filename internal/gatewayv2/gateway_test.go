...
func (inviteTestRuntime) NewState(context.Context, module.Operation) (module.Transition, error) {
...
func (inviteTestRuntime) PlayerJoined(context.Context, module.Operation, module.OpaqueState, string) (module.Transition, error) {
	return module.Transition{}, nil
}
func (inviteTestRuntime) PlayerLeft(context.Context, module.Operation, module.OpaqueState, string) (module.Transition, error) {
	return module.Transition{}, nil
}
func (inviteTestRuntime) Apply(context.Context, module.Operation, module.OpaqueState, string, module.OpaqueState) (module.Transition, error) {
	return module.Transition{}, nil
}
func (inviteTestRuntime) ProjectSnapshot(context.Context, module.Operation, module.OpaqueState, module.Viewer) (module.Projection, error) {
	return module.Projection{Payload: inviteTestOpaque("example.View", "view", module.MaxMessageBytes)}, nil
}
func (inviteTestRuntime) ProjectDelta(context.Context, module.Operation, module.OpaqueState, module.OpaqueState, module.OpaqueState, module.Viewer) (module.Projection, error) {
